...
impl OpenRouterProvider {
    ...
    pub fn with_timeouts(api_key: String, model: String, max_tokens: u32, connect_timeout: Duration, response_timeout: Duration) -> Self {
...
mod tests {
    ...
    #[test]
    fn test_provider_uses_configured_max_tokens() {
    ...
    #[test]
    fn test_provider_with_custom_max_tokens() {
        let provider = OpenRouterProvider::new(
            "test-key".to_string(),
            "anthropic/claude-sonnet-4-20250514".to_string(),
            256,
    ...
    #[test]
    fn test_provider_with_timeouts_preserves_max_tokens() {
        let provider = OpenRouterProvider::with_timeouts(
            "test-key".to_string(),
            "anthropic/claude-sonnet-4-20250514".to_string(),
            384,
        ...
        assert_eq!(provider.max_tokens, 384);
    }

    #[test]
    fn test_request_serialization_includes_max_tokens() {
        let request = OpenRouterRequest {
